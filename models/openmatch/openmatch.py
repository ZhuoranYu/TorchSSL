...
from .openmatch_utils import consistency_loss, Get_Scalar, ova_loss, ova_ent
    ...
    def train(self, args, logger=None):
        ...
        for (_, x_lb, y_lb), (x_ulb_idx, x_ulb_w, x_ulb_s, y_ulb) in zip(self.loader_dict['train_lb'],
            ...
            with amp_cm():
                ...
                logits_open_u1, logits_open_u2 = logits_open[num_lb:].chunk(2)

                logits_x_lb = logits[:num_lb]
                logits_x_ulb_w, logits_x_ulb_s = logits[num_lb:].chunk(2)
                sup_loss = ce_loss(logits_x_lb, y_lb, reduction='mean')

                Lo = ova_loss(logits_open[:num_lb], y_lb) # OVA loss for labeled data
                ...
                total_loss = sup_loss + Lo + 0.1 * L_oem \
                       + 0.5 * L_socr + unsup_loss
