...
from models.v2.v2 import InPLV2
...
if __name__ == "__main__":
    ...
    parser.add_argument('--loss_form', default='mse', type=str)
    parser.add_argument('--sharpening', default=False, type=bool)
    parser.add_argument('--z_m', type=float, default=0.999)
